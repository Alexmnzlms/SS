...
cd ../memoria
make
cp ./memoria.pdf ../Memoria_EjercicioMontecarlo_AlejandroManzanaresLemus.pdf
cd ..
...
zip -r EjercicioMontecarlo_AlejandroManzanaresLemus.zip codigo-fuente Memoria_EjercicioMontecarlo_AlejandroManzanaresLemus.pdf
