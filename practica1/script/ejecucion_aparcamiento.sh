...
for i in $(seq 0.1 0.1 0.9); do
	...
	cat "out/min_100000_100_2_${i}" >> ../data/aparcamiento_prob_min.data
	cat "out/min_linea_100000_100_2_${i}" >> ../data/aparcamiento_prob_min_linea.data
done
...
for i in $(seq 1 1 10); do
	...
	cat "out/min_100000_100_${i}_0.9" >> ../data/aparcamiento_vision_min.data
	cat "out/min_linea_100000_100_${i}_0.9" >> ../data/aparcamiento_vision_min_linea.data
done
...
for i in 10 100 1000 10000 100000; do
	...
	cat "out/min_${i}_100_2_0.9" >> ../data/aparcamiento_veces_min.data
	cat "out/min_${i}_100_2_0.9" >> ../data/aparcamiento_veces_min_linea.data
done
