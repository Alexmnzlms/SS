...
mv ISR.png "../memoria/img/ISR_7.png"
mv ISR_acumulado.png "../memoria/img/ISR_acumulado_7.png"
...
mv ISR.png "../memoria/img/ISR_8.png"
mv ISR_acumulado.png "../memoria/img/ISR_acumulado_8.png"
